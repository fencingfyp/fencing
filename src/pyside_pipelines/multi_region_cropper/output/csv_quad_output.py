...
def row_mapper(row) -> Quadrilateral:
    ...
    return {
        "id": "quad",  # this makes it compatible with FrameInfoManager, even though we don't actually use the "id" field for anything
        "quad": Quadrilateral(
            [
...
class CsvQuadOutput(RegionOutput):
    def __init__(self, csv_path: str):
        ...
        self._writer.writerow(get_header_row())

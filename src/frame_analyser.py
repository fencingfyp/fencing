...
from src.util import NORMAL_UI_FUNCTIONS, UiCodes, setup_input_video_io
...
def main():
    ...
    while True:
        ...
        action = ui.take_user_input(delay, [*NORMAL_UI_FUNCTIONS, UiCodes.CUSTOM_1, UiCodes.CUSTOM_2, UiCodes.CUSTOM_3, UiCodes.CUSTOM_4], 
        ...
        if action == UiCodes.TOGGLE_SLOW:
            ...
            current_frame_index = int(max(0, current_frame_index - fps * 10))  # skip back 10 seconds
            cap.set(cv2.CAP_PROP_POS_FRAMES, current_frame_index)
